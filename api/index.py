...
SYSTEM_PROMPT = """
    ...
    Available Tools:
    - get_weather(city: str): Takes city name as input string and returns weather info about the city.
    ...
    PLAN: { "step": "PLAN", "content": "Lets see if we have any available tool the list of available tools" }
